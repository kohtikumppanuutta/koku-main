				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table xmlns:st1="urn:schemas-microsoft-com:office:smarttags" xmlns:svg="http://www.w3.org/2000/svg" start-indent="0.70875pt" text-align="left" color="#000000">
						...
						<fo:table-body start-indent="0pt" end-indent="0pt">
							<fo:table-row>
								<fo:table-cell number-columns-spanned="5" border-top-style="solid" border-top-color="#000000" border-top-width="0pt" border-bottom-style="solid" border-bottom-color="#000000" border-bottom-width="0pt" border-left-style="solid" border-left-color="#000000" border-left-width="0pt" border-right-style="none" border-right-color="black" border-right-width="0pt">
									<fo:block-container>
