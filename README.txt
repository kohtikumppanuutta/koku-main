...
ui/		User interface layer artifacts (e.g. portlet projects)
services/	Service layer artifacts (e.g. SOA service interface descriptions and implementations)
service-api/	Service layer API
processes/	Process layer artifacts.
